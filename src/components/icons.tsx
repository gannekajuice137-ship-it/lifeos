...
// Minimal SVG icons — inline, no CDN, no icon library
// Using simple path-based icons matching Apple's SF Symbols style
...
export function CfIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function WikiIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function ClockIcon({ className, style }: { className?: string; style?: CSSProperties }) {
  return (
...
export function ExternalLinkIcon({ className, style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
/* Mood faces — level 1 (rough) to 5 (great), pure line art */
export function MoodIcon({ level, className }: { level: 1 | 2 | 3 | 4 | 5; className?: string }) {
  const eyes =
    level === 5 ? (
      <>
        <path d="M8.5 9.5c1.2-1.2 2.3-1.2 3.5 0" />
        <path d="M12.5 9.5c1.2-1.2 2.3-1.2 3.5 0" />
      </>
    ) : (
      <>
  ...
  const mouth = {
    1: <path d="M8 14.5c1.2-1 2.4-1.5 4-1.5s2.8.5 4 1.5" />,
    2: <line x1="8.5" y1="15" x2="15.5" y2="15" />,
    3: <path d="M8.5 14.5c1 1.2 2 1.8 3.5 1.8s2.5-.6 3.5-1.8" />,
    4: <path d="M8 14c1.3 1.8 2.7 2.7 4 2.7s2.7-.9 4-2.7" />,
    5: <path d="M8 13.5c1.4 2.2 2.8 3.3 4 3.3s2.6-1.1 4-3.3" />,
  }[level];
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
